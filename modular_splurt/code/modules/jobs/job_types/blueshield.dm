/datum/job/blueshield
	...
	alt_titles = list("Command Security", "Command Guard", "Command Bodyguard", "Blueguard", "Blueshit", "Blueslut", "Bluestud", "Blueballs")
	...
	blacklisted_quirks = list(/datum/quirk/mute, /datum/quirk/brainproblems, /datum/quirk/nonviolent, /datum/quirk/paraplegic, /datum/quirk/blindness, /datum/quirk/lewdblind, /datum/quirk/monophobia, /datum/quirk/insanity)
	threat = 3
